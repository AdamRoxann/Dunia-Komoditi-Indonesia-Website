    ...
    <div class="container">
                    ...
                    <div class="widgets">
                        <div class="footer-logo">
                            ...
                            <a href="./index.html" style="color: white; font-size: 20px;">
                                <!-- <img src="assets/images/logo.png" alt=""> --> PT. Dunia Komoditi Indonesia
                            </a>
                        </div>
                        <p>
                    ...
                    <div class="widgets">
                        ...
                        <ul class="footer-contact-list">
                            <li>
                                ...
                                Visit our office<br>
                                Jalan Bendi Besar 186, Kebayoran Lama DKI Jakarta, 12240, IDN
                            </li>
                            <li>
                                <i class="icon icon-phone3"></i>
                                <a style="color: white" href="tel:081260774365">+6281260774365</a>
                            </li>
                            <li>
        ...
        <div class="copyright-content">
            <div class="row">
            <div class="col-md-6">
                <p>Copyright &copy;2021, <a href="#">PT. Dunia Komoditi Indonesia</a>. All Rights Reserved.</p>
            </div>
            <div class="col-md-6">
